...
# default, and 1.7 if EXPERIMENTAL_USE_JAVA7 is set
...
#
# For Java 1.7 and better, we require OpenJDK on linux and Oracle JDK on Mac OS.
...
$(info ************************************************************)
$(info You asked for an OpenJDK 8 build but your version is)
