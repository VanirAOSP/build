...
define do-clang-flags-subst
  ...
  TARGET_GLOBAL_CLANGPP_FLAGS := $(subst $(1),$(2),$(TARGET_GLOBAL_CLANGPP_FLAGS))
...
TARGET_GLOBAL_CLANGPP_FLAGS += $(filter-out $(CLANG_CONFIG_UNKNOWN_CFLAGS),$(TARGET_GLOBAL_CPPFLAGS))
