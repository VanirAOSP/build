...
ifeq ($(VANIR_THUMB_FSTRICT_OPTIONS),)
  VANIR_THUMB_FSTRICT_OPTIONS := -fno-strict-aliasing
endif
...
TARGET_GLOBAL_CFLAGS += \
	$(DEBUG_SYMBOL_FLAGS) $(DEBUG_FRAME_POINTER_FLAGS) $(GRAPHITE_FLAGS)

TARGET_GLOBAL_CPPFLAGS += \
	$(DEBUG_SYMBOL_FLAGS) $(DEBUG_FRAME_POINTER_FLAGS) $(GRAPHITE_FLAGS)

CLANG_TARGET_GLOBAL_CFLAGS += \
	$(DEBUG_SYMBOL_FLAGS) $(DEBUG_FRAME_POINTER_FLAGS)
